...
def baliho():
	try:
		...
		print ' '
		###############################################################
		print (R + '      {POWERED BY' + G  +' SHINICHI HIDEYOSHI}' )
		print ' '
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     GK BOLEH TAU 'SHINICHI HIDEYOSHI'
    Name       OSIF 'Open Source Information Facebook'
    CodeName   SHINICHI HIDEYOSHI
    version    full version
    Date       4/09/2019 21:35:12
    Team       SHINICHI SECURITY
    Email      shinichihideyoshish@gmail.com
    instagram  shinichi_hideyoshi.sh
...
def main():
  ...
  try:
	cek = raw_input(R + 'SINOCHI HIDEYOSHI' + W +' >> ')
